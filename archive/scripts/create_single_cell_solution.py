#!/usr/bin/env python3
"""
Create a single-cell solution that works properly in Kaggle.
"""

import json

def create_single_cell_solution():
    """Create a single-cell notebook that works in Kaggle."""
    
    notebook = {
        "cells": [
            # Cell 1: Complete T4x2 Solution
            {
                "cell_type": "code",
                ...
                "source": [
                    ...
                    "\n",
                    "def find_data_path():\n",
                    "    \"\"\"Find data files in Kaggle or local environment.\"\"\"\n",
                    "    paths = [\n",
    ...
    # Save the single-cell solution
    with open('neurips-t4x2-single-cell.ipynb', 'w', encoding='utf-8') as f:
        json.dump(notebook, f, indent=1, ensure_ascii=False)
    
    print("✅ Single-cell T4x2 solution created!")
    print("📁 File: neurips-t4x2-single-cell.ipynb")
    print("🎯 Features:")
    print("   ✅ Single cell with everything")
    print("   ✅ Automatic dependency installation")
    print("   ✅ All imports at the top")
    print("   ✅ Complete training pipeline")
    print("   ✅ DataParallel tensor fixes")
    print("   ✅ Submission generation")
    print("   ✅ No import errors")

if __name__ == "__main__":
    create_single_cell_solution()