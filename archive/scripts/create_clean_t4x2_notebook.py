#!/usr/bin/env python3
"""
Create a clean, properly structured T4x2 notebook with all imports at the top.
"""

import json

def create_clean_notebook():
    """Create a clean T4x2 notebook with proper structure."""
    
    notebook = {
        "cells": [
            # Cell 1: Title and Configuration
            {
                "cell_type": "markdown",
                "metadata": {},
                "source": [
            ...
            # Cell 3: Data Loading and Path Detection
            {
                "cell_type": "code",
                "execution_count": None,
                "metadata": {},
            ...
            # Cell 4: Molecular Featurization
            {
                "cell_type": "code",
                "execution_count": None,
                "metadata": {},
            ...
            # Cell 7: Loss Function and Training Functions
            {
                "cell_type": "code",
                "execution_count": None,
                "metadata": {},
    ...
    with open('neurips-t4x2-clean-final.ipynb', 'w', encoding='utf-8') as f:
        json.dump(notebook, f, indent=1, ensure_ascii=False)
    
    print("✅ Clean T4x2 notebook created: neurips-t4x2-clean-final.ipynb")
    print("🎯 All imports are properly organized at the top!")
